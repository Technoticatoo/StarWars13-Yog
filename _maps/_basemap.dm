...
#include "yogstation\map_files\generic\CentCom.dmm" //all yogstation maps are in the _maps/yogstation folder
		...
		#include "map_files\IPB Purge\purge.dmm"
		#include "map_files\IPB Purge\planets.dmm"
		#include "map_files\IPB Purge\rebel_base.dmm"
		#include "map_files\IPB Purge\rebel_underground.dmm"
