...
#define REBEL_DESTRUCTION_RESULT_FLUKE 0
#define REBEL_DESTRUCTION_RESULT_REBEL_WIN 1
#define REBEL_DESTRUCTION_RESULT_CREW_WIN 2
#define REBEL_DESTRUCTION_RESULT_CREW_WIN_SYNDIES_DEAD 3
#define REBEL_DESTRUCTION_RESULT_NOSURVIVORS 4
