...
GLOBAL_LIST_EMPTY(droid_markings_list)
...
GLOBAL_LIST_INIT(side_prefs, list("Empire", "Rebels", "Mercenaries"))
GLOBAL_LIST_INIT(lightsaber_color, list("blue", "green", "purple", "red", "gold", "white", "orange", "cyan"))
GLOBAL_LIST_INIT(hyperspace_targets, list())
