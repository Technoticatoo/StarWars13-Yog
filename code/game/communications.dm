...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_REBCOM  = FREQ_REBCOM ,
	RADIO_CHANNEL_REBMIL = FREQ_REBMIL,
	RADIO_CHANNEL_REBMED = FREQ_REBMED,
	RADIO_CHANNEL_REBSEC = FREQ_REBSEC,
	RADIO_CHANNEL_REBSQD = FREQ_REBSQD,
	RADIO_CHANNEL_REBBRD = FREQ_REBBRD,
	RADIO_CHANNEL_MERCCOM = FREQ_MERCCOM,
	RADIO_CHANNEL_MERCSUP = FREQ_MERCSUP,
	RADIO_CHANNEL_MERCBRD = FREQ_MERCBRD
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_REBCOM]" = RADIO_CHANNEL_REBCOM,
	"[FREQ_REBMIL]" = RADIO_CHANNEL_REBMIL,
	"[FREQ_REBMED]" = RADIO_CHANNEL_REBMED,
	"[FREQ_REBSEC]" = RADIO_CHANNEL_REBSEC,
	"[FREQ_REBSQD]" = RADIO_CHANNEL_REBSQD,
	"[FREQ_REBBRD]" = RADIO_CHANNEL_REBBRD,
	"[FREQ_MERCCOM]" = RADIO_CHANNEL_MERCCOM,
	"[FREQ_MERCSUP]" = RADIO_CHANNEL_MERCSUP,
	"[FREQ_MERCBRD]" = RADIO_CHANNEL_MERCBRD
))
