...
/datum/game_mode/changeling
	...
	protected_jobs = list("Alpha Squad Sergeant", "Bravo Squad Sergeant", "Alpha Squad Stormtrooper", "Bravo Squad Stormtrooper", "Warden", "Detective", "Captain of the Guard", "Captain", "Lieutenant", "Sith", "Enperor") //YOGS - added hop
	required_players = 15
	required_enemies = 1
