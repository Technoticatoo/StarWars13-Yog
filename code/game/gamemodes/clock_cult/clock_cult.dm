...
/datum/game_mode/clockwork_cult
	...
	protected_jobs = list("AI", "Cyborg", "Alpha Squad Sergeant", "Bravo Squad Sergeant", "Alpha Squad Stormtrooper", "Bravo Squad Stormtrooper", "Warden", "Detective", "Captain of the Guard", "Captain", "Lieutenant", "Sith", "Enperor") //Silicons can eventually be converted
