/datum/game_mode/devil
	...
	protected_jobs = list("Alpha Squad Sergeant", "Bravo Squad Sergeant", "Alpha Squad Stormtrooper", "Bravo Squad Stormtrooper", "Warden", "Detective", "Captain of the Guard", "Captain", "Lieutenant", "Sith", "Enperor", "AI")
	required_players = 0
	required_enemies = 1
