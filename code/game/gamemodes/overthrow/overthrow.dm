...
/datum/game_mode/overthrow
	...
	restricted_jobs = list("Alpha Squad Sergeant", "Bravo Squad Sergeant", "Alpha Squad Stormtrooper", "Bravo Squad Stormtrooper", "Warden", "Interrogator", "Captain of the Guard", "Captain", "Lieutenant", "Sith", "Enperor", "Detective", "AI", "Cyborg", "Heads Engineer", "Research Director", "Chief Medical Officer", "Coalition Administrative Officer")
