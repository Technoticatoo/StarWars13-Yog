...
GLOBAL_LIST_INIT(channel_tokens, list(
	...
	RADIO_CHANNEL_REBCOM = RADIO_TOKEN_REBCOM,
	RADIO_CHANNEL_REBMIL = RADIO_TOKEN_REBMIL,
	RADIO_CHANNEL_REBMED = RADIO_TOKEN_REBMED,
	RADIO_CHANNEL_REBSEC = RADIO_TOKEN_REBSEC,
	RADIO_CHANNEL_REBSQD = RADIO_TOKEN_REBSQD,
	RADIO_CHANNEL_REBBRD = RADIO_TOKEN_REBBRD,
	RADIO_CHANNEL_MERCCOM = RADIO_TOKEN_MERCCOM,
	RADIO_CHANNEL_MERCSUP = RADIO_TOKEN_MERCSUP,
	RADIO_CHANNEL_MERCBRD = RADIO_TOKEN_MERCBRD,
