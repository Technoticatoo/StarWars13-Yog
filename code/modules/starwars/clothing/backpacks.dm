...
//STAR WARS
/obj/item/storage/backpack/starwars
	icon_state = "backpack"
	item_state = "backpack"
	alternate_worn_icon = 'icons/starwars/clothing/backpacks_mob.dmi'
	icon = 'icons/starwars/clothing/backpacks_obj.dmi'
	lefthand_file = 'icons/starwars/clothing/backpack_lefthand.dmi'
	righthand_file = 'icons/starwars/clothing/backpack_righthand.dmi'

/obj/item/storage/backpack/starwars/stormtrooper
	name = "stormtrooper backpack"
	desc = "It's a very robust backpack."
	icon_state = "stormpack"
	item_state = "stormpack"

/obj/item/storage/backpack/starwars/rebels
	name = "rebel backpack"
	desc = "It's a very robust backpack."
	icon_state = "rebelpack"
	item_state = "rebelpack"