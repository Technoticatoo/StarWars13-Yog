/obj/effect/proc_holder/spell/targeted/forcetelepathy
	name = "Force Telepathy"
...
/obj/effect/proc_holder/spell/targeted/forcetelepathy/cast(list/targets, mob/living/simple_animal/revenant/user = usr)
