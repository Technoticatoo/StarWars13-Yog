...
//	minimal_player_age = 14
	...
	access = list(ACCESS_REBELS_MEDICAL, ACCESS_REBELS_SUPPORT, ACCESS_REBELS_GENERAL)
	minimal_access = list(ACCESS_REBELS_MEDICAL, ACCESS_REBELS_SUPPORT, ACCESS_REBELS_GENERAL)
...
/datum/outfit/job/rmedic
	...
	ears = /obj/item/radio/headset/rebels/medical
