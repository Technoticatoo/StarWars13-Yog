...
//	suit_store = /obj/item/gun/energy/e_gun
	...
	backpack_contents = list(/obj/item/gun/energy/e_gun/starwars/e11=1, /obj/item/melee/baton/loaded=1, /obj/item/card/id/departmental_budget/sec=1, /obj/item/clothing/suit/armor/blastarmorblack=1)
