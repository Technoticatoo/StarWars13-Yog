...
//	minimal_player_age = 14
	...
	access = list(ACCESS_REBELS_SUPPORT, ACCESS_REBELS_GENERAL)
	minimal_access = list(ACCESS_REBELS_SUPPORT, ACCESS_REBELS_GENERAL)
...
//	belt = /obj/item/pda/heads/hos
	ears = /obj/item/radio/headset/rebels/support
